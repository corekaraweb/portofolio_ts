            ...
            <div className="fv">
              ...
              <div className="txt">
                <p>
                  ...
                  <br />
                  <span className="sub">※ 本サイトは2027年3月時点の完成形を想定して制作しています（2026年10月現在制作中）</span>
                </p>
              </div>
            </div>
            ...
            <div className="timeline">
              <div className="timeline-inner">
                ...
                <div className="after2026 timeline-block wow animated fadeInUp">
                  ...
                  <div className="contents">
                    <h2>ITシステム科 職業訓練</h2>
                    <p>Java・AWS・Laravel・React・TypeScript を体系的に学習。Java Gold SE17・AWS 3冠を取得し、バックエンドとクラウドの基礎を確立しました。学んだ技術は座学で終わらせず、福祉の現場で感じた課題を題材にした社内向けWebアプリや備品管理システムなどをポートフォリオとして実装しました。</p>
                    <div className="badgelist">
                ...
                <div className="item wow animated fadeInUp">
                  <div className="contents">
                    ...
                    <div className="txt">
                      ...
                      <p>WordPressのオリジナルテーマで開発した写真ブログです。開発や更新のしやすさを重視し、クラシックテーマで構築しました。斜めに傾けたサムネイルリストの疑似的スクロールや、タグ指定による検索など、UI演出とクエリ制御の両面で工夫しました。</p>
                      <div className="tags">
                        <span>HTML</span>
                        <span>CSS</span>
                        <span>Sass</span>
